...
<main>
  <h1>Clientes</h1>
  <canvas bind:this={newClientsCanvas} width="500" height="200"></canvas>
  <canvas bind:this={clientSatisfactionCanvas} width="500" height="200"></canvas>
  <canvas bind:this={industriesServedCanvas} width="350" height="50"></canvas>
</main>