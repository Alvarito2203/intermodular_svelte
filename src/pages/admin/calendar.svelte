<script>
  ...
  <main>
    <h1>Calendario</h1>
    <canvas bind:this={eventsScheduledCanvas} width="800" height="400"></canvas>
    <canvas bind:this={meetingDurationsCanvas} width="800" height="400"></canvas>
    <canvas bind:this={eventTypesCanvas} width="800" height="400"></canvas>
  </main>